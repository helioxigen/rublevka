...
from ...database.models import CountryProperty
...
def get_country_properties(limit=32, offset=0):  # noqa: E501
    ...
    countries_properties: List[CountryProperty] = current_app.models.CountryProperty \
    ...
    return jsonify(InlineResponse200(
        ...
        ) for property in countries_properties],
