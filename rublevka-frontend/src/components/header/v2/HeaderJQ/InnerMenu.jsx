...
const Sale = styled.div`
  ...
  &:after {
    ...
    left: 0;
    right: 0;
    background: url(${require('assets/images/white-pattern.svg')}) repeat;
    background-size: 180%;
  }
          ...
          <Wrapper>
            ...
            {props.dealType === 'arenda' && (
              <StLink to={`/zagorodnaya/${props.dealType}/ofis`}>
                <Img
                  src={require('assets/images/menu-office.jpg')}
                  srcSet={`${require('assets/images/menu-office@2x.jpg')} 2x`}
                  alt="Офисы"
                />
                <Text>Офисы</Text>
              </StLink>
