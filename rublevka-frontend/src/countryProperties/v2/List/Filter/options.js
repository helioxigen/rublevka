...
export const prices = {
  ...
  rub: {
    sale: [
      ...
      { value: 20, label: '20 млн' },
      { value: 30, label: '30 млн' },
      { value: 40, label: '40 млн' },
      { value: 50, label: '50 млн' },
      { value: 60, label: '60 млн' },
      { value: 70, label: '70 млн' },
      { value: 80, label: '80 млн' },
      { value: 90, label: '90 млн' },
      { value: 100, label: '100 млн' },
      { value: 110, label: '110 млн' },
      { value: 120, label: '120 млн' },
      { value: 130, label: '130 млн' },
      { value: 140, label: '140 млн' },
      { value: 150, label: '150 млн' },
      { value: 160, label: '160 млн' },
      { value: 170, label: '170 млн' },
      { value: 180, label: '180 млн' },
      { value: 190, label: '190 млн' },
      { value: 200, label: '200 млн' },
      { value: 210, label: '210 млн' },
      { value: 220, label: '220 млн' },
      { value: 230, label: '230 млн' },
      { value: 240, label: '240 млн' },
      { value: 250, label: '250 млн' },
      { value: 260, label: '260 млн' },
      { value: 270, label: '270 млн' },
      { value: 280, label: '280 млн' },
      { value: 290, label: '290 млн' },
