...
export default {
  common: {
    ...
    description: {
      step1:
        'Оставьте заявку — наш агент подберет все подходящие предложения и вышлет вам самые интересные',
      step2:
        'Ваша заявка уже оформлена, но мы хотели бы с вами познакомиться. Как мы можем к вам обращаться?',
