    ...
    <ul>
      {items.map(item =>
        <li className="about-equipment-list-item">
          <img className="about-equipment-list-item-image" src={checkmark} alt="checkmark" width="9" height="8"/>
