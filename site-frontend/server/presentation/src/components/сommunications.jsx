...
export default ({
  gasSupply, waterSupply, sewerageSupply, powerSupply,
  condition, renovate, furniture,
}) => {
  const showCommunications = !![gasSupply, powerSupply, sewerageSupply, waterSupply].filter(item => item).length;
