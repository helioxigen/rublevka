...
// actions
import * as _ContactsActions from 'cem/_contacts/actions';
import * as PaginationActions from 'core/actions/pagination';
import * as FilterActions from 'core/actions/filters';

// constants
import { resourceName } from 'cem/_contacts/constants/defaults';

// UI
import UI from 'cem/components/ui';

// components
import Card from 'cem/_contacts/components/list/card';
import Filter from 'cem/_contacts/components/list/filter';
...
class List extends Component {
  ...
  load({ state, actions }) {
    ...
    actions.loadContacts(options, this.group);
  }
