...
// actions
import * as _DealsActions from 'cem/_deals/actions';
import * as PaginationActions from 'core/actions/pagination';
import * as FilterActions from 'core/actions/filters';

// constants
import { titles, resourceName } from 'cem/_deals/constants/defaults';

// UI
import UI from 'cem/components/ui';

// components
import Card from 'cem/_deals/components/card';
import Filter from 'cem/_deals/components/filter';
...
class List extends Component {
  static propTypes = {
    state: PropTypes.shape({
      _deals: PropTypes.object.isRequired,
  ...
  load({ state, actions }) {
    ...
    actions.loadDeals(options, this.group);
  }
