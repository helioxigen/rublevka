...
import { getDefaultsByGroup, apiPathByGroup } from 'cem/_reports/constants/defaults';
...
export default (queryParams, group, options = {}) => (dispatch) => {
  ...
  const params = recursiveCleanUp(mapParams(mergeParams(defaultQueryParams, queryParams)));
