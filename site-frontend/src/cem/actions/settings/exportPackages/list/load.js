...
import { defaultQueryParamsByGroup, resourceName } from 'cem/constants/settings/exportPackages/defaults';
import { updatePagination } from 'core/actions/pagination';

const loadPackages = (queryParams, group) => (dispatch) => {
  dispatch(loadListStarted(types.LOAD_PACKAGES, group));

  return loadList(resourceName, group, { defaultQueryParamsByGroup }, { ...queryParams, orderBy: { id: 'asc' } })
    .then(
      ({ items, pagination }) => {
