...
export const transformSettlementOut = settlement => {
  ...
  return {
    ...
    location: values.location
      ? transformLocationOut(values.location)
      : { linkedLocalityIds: [] },
    aliases: normalizeArray(values.aliases),
    details: values.details
      ? transformSettlementDetailsOut(values.details)
      : {
...
export const transformSettlementIn = data => {
  ...
  return {
    ...values,
    location: values.location
      ? transformLocationIn(values.location)
      : undefined,
    details: values.details
      ? transformSettlementDetailsIn(values.details)
      : undefined,
