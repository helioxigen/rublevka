  ...
  render() {
        ...
        <Container className={sUtils.pushedTop8}>
          <Row>
            <Col xs="20" sm="7" smOffset="6">
              <Alert>
                <Heading size="md" className={sUtils.resetIndent}>
                  Вы уже вошли
                </Heading>
              </Alert>
            </Col>
    ...
    return (
      <Container className={sUtils.pushedTop8}>
        <Row xs="center">
          <Col xs="20">
            <Heading size="lg" className={sUtils.pushedBottom6}>
              Вход в ЦЕМ
            </Heading>
          </Col>
        </Row>
        <Row>
          <Col sm="8" smOffset="6">
            {auth.errors && (
              <Alert>
                {auth.errors.map(error => (
                  <p>
                    <strong>{error.param}</strong>: {error.message}
                  </p>
                ))}
              </Alert>
            )}
            <Form.Container onSubmit={this.handleOnSubmit}>
              ...
              <Row>
                <Col xs="20">
                  <Button type="submit" kind="primary" size="md" block>
                    Войти
                  </Button>
                </Col>
              </Row>
