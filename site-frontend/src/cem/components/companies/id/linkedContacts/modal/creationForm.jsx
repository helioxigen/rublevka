  ...
  submitValidator()(
    class extends Component {
      ...
      create(values) {
        ...
        return actions
          .createContact(companyId, values)
          .then(() => this.props.onPreviousStep());
      }
      ...
      render() {
        ...
        return (
          <Form.Container
            onSubmit={handleSubmit(::this.create, ::this.onCreateSuccess)}
          >
              ...
              <Row>
                <Col xs="20">
                  ...
                  <p className={sUtils.pushedBottom3}>
                    ...
                    {fields.details.phoneNumber.value} не был найден, но вы
                    можете его создать
                  </p>
                </Col>
              </Row>
                ...
                <Col sm="20">
                  ...
                  >
                    <Input
                      block
                      type="tel"
                      /* mask="+7 (111) 111-11-11" placeholder="+7 (___) ___ - __ - __" autoComplete="off" */ value={
                        fields.details.phoneNumber.value
                      }
                    />
                  </FormField>
                </Col>
                ...
                <Col sm="20">
                  ...
                  >
                    <AsyncSelect
                      ...
                      {...fields.companyDetails.positionId}
                    />
                  </FormField>
                </Col>
              </Row>
            ...
            <Button
              type="button"
              className={cn(sButton.btnWide, sUtils.btnWidth30)}
            ...
            <Button
              type="submit"
              kind="success"
              className={cn(sButton.btnWide, sUtils.btnWidth70)}
