          ...
          <Row>
            <Col lg="16" className={sUtils.pushedBottom3}>
              <Row>
                <Col md="10">
                  <FormField
                    field={fields.information.condition}
              ...
              <Row>
                <Col md="10">
                  <FormField
                    field={fields.information.renovate}
                ...
                <Col md="10">
                  <FormField
                    field={fields.information.furniture}
              ...
              <Row>
                <Col md="10">
                  <FormField
                    field={fields.information.conditioning}
                    options={dict.conditioningKinds}
                ...
                <Col md="10">
                  <FormField
                    field={fields.information.ventilation}
                    options={dict.ventilationKinds}
                    label="Вентиляция"
                    float
                    static={!isUpdateAllowed}
                  >
