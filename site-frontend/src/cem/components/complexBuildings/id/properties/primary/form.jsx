...
import { commonFieldsFormSettings as formSettings } from 'cem/constants/complexBuildings/form';
...
import PropertiesTable from 'cem/containers/complexBuildings/table';
...
class PrimaryProperties extends Component {
  updateComplexBuilding(values) {
    const { actions, complexBuildingData } = this.props;
    ...
    const updatedData = {
      ...complexBuildingData,
      propertyDefaults: {
        ...(complexBuildingData.propertyDefaults || {}),
        ...values,
        saleOffer: transformedDefaults.saleOffer,
      },
    };

    return actions.updateComplexBuilding(complexBuildingData.id, updatedData);
  }
