          ...
          <Col sm="4">
            <Group float>
              <PriceInput
                ...
                placeholder="Цена от"
                type="text"
                disabled={!fields[`stats.price.currency`].value}
                {...fields[`stats.price.from`]}
              />
              <Label>Цена от</Label>
            </Group>
          </Col>
...
const fields = [`id`, `name`, `location.street`, `state`];
