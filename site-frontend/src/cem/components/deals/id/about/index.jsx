      ...
      <Row>
        <section className={s.section}>
          ...
          >
              ...
              {isSensitiveDataVisible && (
                <Col sm="10">
                  <Row>
                    <Col lg="16">
                      <ClientInfo
                        {...this.props.linkedContactData}
                        kindIdField={fields.contactDetails.kindId}
                        isStatic={isFormStatic}
                      />
                    </Col>
                  </Row>
            ...
            <Row className={sUtils.pushedBottom3}>
              <Col lg="18">
                {(!isFormStatic || !!fields.details.note.value) && (
                ...
                <Group>
                  {!isFormStatic && (
                    <Textarea
                      ...
                      kind="primary"
                      {...fields.details.note}
                      value={fields.details.note.value || ``}
                    />
                  )}
