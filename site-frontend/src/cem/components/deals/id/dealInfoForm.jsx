...
export default class extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    this.calculateCommissionSum(
      nextProps.fields.details.expectedAgentFee.value,
      nextProps.fields.details.budget.value,
    );
  }

  calculateCommissionSum(
    feeRate = 0,
    budget = this.props.fields.details.budget.value,
  ) {
          ...
          <Row>
            <Col sm="10">
              <Group>
                ...
                <Static>
                  <FormattedCurrency
                    symbol={fields.details.currency.value}
                    value={fields.details.budget.value}
                  />
                </Static>
              </Group>
            </Col>
        ...
        <Row>
          <Col sm="10">
            <Group>
              ...
              <Daypicker
                className={cn(sUtils.fullWidth, sUtils.pushedTop_5)}
                restrict="past"
                ...
                control={
                  <Input
                    ...
                    {...fields.details.expectedFinishDateAt}
                    type="text"
                  />
                }
                button={
            ...
            <Group>
              <Label className={s.radioLabel} block>
                <Input
                  ...
                  {...fields.isAgentFixed}
                  value="false"
                  checked={fields.isAgentFixed.value !== `true`}
                  disabled={isStatic}
                />
                Процент
              </Label>
        ...
        {fields.isAgentFixed.value !== `true` && (
          <Row>
            <Col sm="10">
              <FormField
                label="Комиссия, %"
                field={fields.details.expectedAgentFee}
                float
                static={isStatic}
              >
            ...
            <Col sm="10">
              <Group>
                ...
                <Static>
                  <FormattedCurrency
                    value={this.state.commissionSum}
                    symbol={fields.details.currency.value}
                  />
                </Static>
              </Group>
          ...
          <Row>
            <Col sm="10">
              <FormField
                ...
                field={fields.details.expectedAgentFixedPrice.price}
                float
                static={isStatic}
                price
              >
            ...
            <Col sm="10">
              <FormField
                label="Валюта"
                field={fields.details.expectedAgentFixedPrice.currency}
                float
                static={isStatic}
              >
                <Select
          ...
          <Row>
            <Col sm="10">
              <FormField
                float
                label="ID объекта"
                field={fields.details.propertyId}
                static={isStatic}
              >
                <Input
