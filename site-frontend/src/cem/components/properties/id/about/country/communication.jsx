...
export default ({
  className,
  options,
  fields: { communication, additionalDetails },
  isUpdateAllowed,
}) => (
          ...
          <Col lg="18">
            <Row>
              <Col md="15" lg="10">
                <Group
                  kind={
                    communication.gasSupply.touched &&
                    !!communication.gasSupply.error &&
                    'error'
                  }
                >
                  <Label>Газ</Label>
                  ...
                  {communication.gasSupply.touched &&
                    communication.gasSupply.error && (
                      <Helper>{communication.gasSupply.error}</Helper>
                    )}
                </Group>
              </Col>
            </Row>
              ...
              <Col md="15" lg="10">
                {isUpdateAllowed && (
                  <Group
                    float
                    kind={
                      communication.powerSupply.touched &&
                      !!communication.powerSupply.error &&
                      'error'
                    }
                  >
                    <Input
                    ...
                    {communication.powerSupply.touched &&
                      communication.powerSupply.error && (
                        <Helper>{communication.powerSupply.error}</Helper>
                      )}
                  </Group>
                )}
                {!isUpdateAllowed && (
            ...
            <Row>
              <Col md="15" lg="10">
                <Group
                  kind={
                    communication.sewerageSupply.touched &&
                    !!communication.sewerageSupply.error &&
                    'error'
                  }
                >
                  ...
                  {communication.sewerageSupply.touched &&
                    communication.sewerageSupply.error && (
                      <Helper>{communication.sewerageSupply.error}</Helper>
                    )}
                </Group>
              </Col>
            </Row>
            <Row>
              <Col md="15" lg="10">
                <Group
                  kind={
                    communication.waterSupply.touched &&
                    !!communication.waterSupply.error &&
                    'error'
                  }
                >
                  ...
                  {communication.waterSupply.touched &&
                    communication.waterSupply.error && (
                      <Helper>{communication.waterSupply.error}</Helper>
                    )}
                </Group>
              </Col>
            </Row>
        ...
        <Row>
          <Col lg="16" className={sUtils.pushedBottom3}>
            <ConditionalInput
              ...
              value={additionalDetails.garageArea}
              disabled={!isUpdateAllowed}
            />
            <ConditionalInput
              checkboxLabel="Паркинг"
              inputLabel="Количество машиномест"
              value={additionalDetails.parkingArea}
              disabled={!isUpdateAllowed}
            />
          </Col>
        </Row>
