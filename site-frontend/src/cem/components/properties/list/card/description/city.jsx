          ...
          <Row>
            <Col sm="20">
              ...
              <h2 className={s.fullName}>
                {props.location.subLocalityName
                  ? props.location.subLocalityName
                  : '—'}
                , &nbsp;{props.location.street ? props.location.street : '—'},
                д. {props.location.house ? props.location.house : '—'}, кв.{' '}
                {props.location.flatNumber ? props.location.flatNumber : '—'}
              </h2>
            </Col>
          </Row>
          <Row>
            ...
            {props.specification && (
              <Col className={sUtils.pushedTopXs2} xs="10" sm="7" md="5" lg="3">
                <ParamList label="Площадь">
                  {props.specification.totalArea &&
                    `${props.specification.totalArea} м²`}
            ...
            {props.information && (
              ...
              >
                <ParamList label="Состояние">
                  {props.information.condition &&
                    conditions[props.information.condition]}
