...
class Status extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (data.id !== nextData.id || data.updatedByUserId !== nextData.updatedByUserId || data.createdByUserId !== nextData.createdByUserId) {
      this.load(nextProps);
    }
  }

  load(props) {
    const { actions, data: { updatedByUserId, createdByUserId } } = props;
  ...
  render() {
    const { usersState, className, data, data: { responsibleUserId, updatedByUserId, createdByUserId } } = this.props;
          ...
          {createdByUserData.id &&
            <Col sm="10">
              ...
              <Group className={sUtils.resetIndentation}>
                ...
                <Static>{createdByUserData.firstName} {createdByUserData.lastName}</Static>
              </Group>
            </Col>
          }
          {updatedByUserData.id &&
            <Col className={sUtils.pushedTopXs4} sm="10">
              ...
              <Group className={sUtils.resetIndentation}>
                ...
                <Static>{updatedByUserData.firstName} {updatedByUserData.lastName}</Static>
              </Group>
            </Col>
          }
        </Row>
