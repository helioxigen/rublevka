      ...
      <Row key={key}>
        ...
        <Col xs="10">
          <Group kind={title.touched && title.error && 'error'}>
            <Input valueClassName="floatLabel" placeholder="Title" block type="text" disabled={!isUpdateAllowed}  {...title} />
        ...
        <Col xs="10">
          <Group kind={keywords.touched && keywords.error && 'error'}>
            <Input valueClassName="floatLabel" placeholder="Keywords" block type="text" disabled={!isUpdateAllowed}  {...keywords} />
            {keywords.touched && keywords.error && <Helper>{keywords.error}</Helper>}
          </Group>
        </Col>

        <Col xs="20">
          <Group kind={description.touched && description.error && 'error'}>
            <Input valueClassName="floatLabel" placeholder="Description" block type="text" disabled={!isUpdateAllowed}  {...description} />
            {description.touched && description.error && <Helper>{description.error}</Helper>}
          </Group>
        </Col>

        <Col xs="20">
          <Group kind={h1.touched && h1.error && 'error'}>
            <Input valueClassName="floatLabel" placeholder="H1" block type="text" disabled={!isUpdateAllowed}  {...h1} />
