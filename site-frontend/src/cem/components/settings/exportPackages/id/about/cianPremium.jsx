  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row>
          <Col sm="6">
            <FormField label="Топ-3" field={fields.cianDetails.top} static={!isUpdateAllowed}>
              <Select multi allowCreate {...fields.cianDetails.top} />
            </FormField>
          </Col>
          <Col sm="6" smOffset="1">
            <FormField label="Премиум" field={fields.cianDetails.premium} static={!isUpdateAllowed}>
              <Select multi allowCreate {...fields.cianDetails.premium} />
            </FormField>
          </Col>
          <Col sm="6" smOffset="1">
            <FormField label="Выделение цветом" field={fields.cianDetails.highlight} static={!isUpdateAllowed}>
