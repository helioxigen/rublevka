...
const PhotosDescription = props => (
  <Container fluid>
    <Row>
      ...
      <Col sm="11" className={sUtils.textRight}>
...
export default DropTarget('settlements.photos.card', targetSpec, collectTarget)(
  DragSource('settlements.photos.card', sourceSpec, collectSource)(Card),
);
