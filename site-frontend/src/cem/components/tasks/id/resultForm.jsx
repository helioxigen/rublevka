...
class Result extends Component {
    ...
    return actions
      .updateTask(
        ...
        isTimeline
          ...
          : prepareFormValuesForSubmit(values),
      )
      .then(() => actions.changeStatus(taskId, status));
  }
  ...
  render() {
    ...
    return (
      <Form.Container
        onSubmit={handleSubmit(::this.completeTask, ::this.onSubmitSuccess)}
      >
        <Container fluid className={s.container}>
          <Row>
            <Col xs="20">
              ...
              <Group
                kind={fields.result.touched && fields.result.error && `error`}
              >
                <Textarea
                ...
                />
                {fields.result.touched && fields.result.error && (
                  <Helper>{fields.result.error}</Helper>
                )}
              </Group>
            </Col>
          </Row>
