...
export default (styles = {}, { Form }) => (
  class PriceInput extends Component {
    ...
    transformValue(value) {
      ...
      return !isNaN(Number(valueWithoutSpaces)) ? Number(valueWithoutSpaces) : value;
    }

    render() {
      return (
        <Form.Input {...this.props} value={formatPriceWithGrouping(this.props.value)} onChange={::this.handleChange} onBlur={::this.handleBlur} />
      );
    }
  }
);
