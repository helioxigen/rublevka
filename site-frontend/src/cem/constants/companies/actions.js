export const LOAD_COMPANIES = 'companies.list.load';
export const LOAD_COMPANIES_FAIL = 'companies.list.load.failed';
export const LOAD_COMPANIES_SUCCESS = 'companies.list.load.succeeded';

export const CREATE_COMPANY = 'companies.id.create';
export const CREATE_COMPANY_FAIL = 'companies.id.create.failed';
export const CREATE_COMPANY_SUCCESS = 'companies.id.create.succeeded';

export const LOAD_COMPANY = 'companies.id.load';
export const LOAD_COMPANY_FAIL = 'companies.id.load.failed';
export const LOAD_COMPANY_SUCCESS = 'companies.id.load.succeeded';

export const UPDATE_COMPANY = 'companies.id.update';
export const UPDATE_COMPANY_FAIL = 'companies.id.update.failed';
...
export const LOAD_CONTACT_SUCCESS = 'companies.id.contact.id.load.succeeded';
