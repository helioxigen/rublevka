...
export const CREATE_ID_SUCCESS = 'settings.lead_sources.id.create.succeeded';
export const CREATE_ID_FAIL = 'settings.lead_sources.id.create.failed';

export const UPDATE_ID = 'settings.lead_sources.id.update';
export const UPDATE_ID_SUCCESS = 'settings.lead_sources.id.update.succeeded';
export const UPDATE_ID_FAIL = 'settings.lead_sources.id.update.failed';

export const DELETE_ID = 'settings.lead_sources.id.delete';
export const DELETE_ID_SUCCESS = 'settings.lead_sources.id.delete.succeeded';
