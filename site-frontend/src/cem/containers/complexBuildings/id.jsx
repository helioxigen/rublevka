...
class Id extends Component {
  ...
  render() {
    ...
    const initialValues = {
      ...data,
      location: id === 'create' ? complexData.location : data.location,
    };

    const permissionsProps = {
      isUpdateAllowed: hasRight(
        'complex_building_update',
      ...
      isImageUploadAllowed: hasRight(
        'complex_building_image_upload',
        data.responsibleUser && data.responsibleUser.id,
        data.responsibleUser && data.responsibleUser.departmentId,
        data.responsibleUser && data.responsibleUser.divisionId,
      ),
      isDocumentsPreviewAndUpdateAllowed: hasRight(
        'complex_building_documents',
        data.responsibleUser && data.responsibleUser.id,
        data.responsibleUser && data.responsibleUser.departmentId,
        data.responsibleUser && data.responsibleUser.divisionId,
      ),
    ...
    return (
      <section>
        <Header
          {...{ complexId, actions, formKey: id, initialValues, data }}
          {...permissionsProps}
        />
...
const pickActions = dispatch => ({
  actions: bindActionCreators(
    { ...ComplexBuildingsActions, loadUser, pop, pushPath, loadComplex },
    dispatch,
  ),
});
