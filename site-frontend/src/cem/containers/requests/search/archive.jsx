...
class ArchiveListContainer extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const nextPagination = nextProps.state.pagination[`searchRequests.archive`] || {};
    ...
    if (isPaginationUpdated || isFilterUpdated) {
      actions.loadSearchRequests(`archive`, { pagination: { offset: nextPagination.offset, limit: nextPagination.limit }, filter: nextFilter });
    }
  }
      ...
      <section>
        <Container fluid>
          <div className={s.header}>
            <Row>
              <Col xs="20">
                <Heading size="lg">Архивные заявки на поиск объектов недвижимости</Heading>
                <Button className={sButton.btnTo} size="xs" to="/requests/properties/search">
