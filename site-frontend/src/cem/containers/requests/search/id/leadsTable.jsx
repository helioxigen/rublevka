...
const { Grid, Heading, Button, Icon, Tooltip, Loading, Label, Table } = UI;
              ...
              <Table.Container width="100%" className={sUtils.width122}>
                ...
                {items.map(item => {
                  const {
                    ...
                    contactDetails = {},
                    requestDetails,
                    requestDetails: { saleOffer = {}, rentOffer = {} },
                  } = item;
                  ...
                  return (
                    <Table.Row>
                      ...
                      <Table.Cell
                        className={cn(statesDict && s[statesDict.style])}
                      >
                        {stateDetails.toApprove ? (
                          <Label kind="warning">ОЖИДАЕТ ПОДТВЕРЖДЕНИЯ</Label>
                        ) : (
                          !!statesDict && statesDict.title
                        )}
                      </Table.Cell>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        {propertyDicts.kinds[requestDetails.kind]}
                      </Table.Cell>
                      <Table.Cell>
                        {!!saleOffer.price && (
                          <FormattedCurrency
                      ...
                      <Table.Cell>
                        ...
                        >
                          <Button
                            ...
                            to={`/client_leads/recommendation/${item.id}`}
                            size="xs"
                          >
                            ...
                            >
                              <div>
                                <LeadModal
                                  ...
                                  data={item}
                                  searchRequestId={id}
                                  initialValues={leadEditFormInitialValues}
                                >
                                  <Button
                                    className={sButton.btnTableAction}
                                    size="xs"
                          ...
                          !stateDetails.toApprove && (
                            ...
                            >
                              <Button
                                ...
                                onClick={() =>
                                  actions
                                    .processLead(item.id, 'process')
                                    .then(() => actions.loadLeads(id))
                                }
                              >
