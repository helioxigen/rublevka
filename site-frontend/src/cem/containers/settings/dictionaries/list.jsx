...
const { Heading, Grid: { Container, Col }, Grid } = UI;
  ...
  <section className={s.section}>
    <Container fluid>
      ...
      <List title="Посёлки">
        ...
        <Row kind="settlement_external_infrastructure">Список внешней инфраструктуры</Row>
        <Row kind="settlement_internal_infrastructure">Список внутренней инфраструктуры</Row>
      </List>
      <List title="Сделки">
      ...
      <List title="Лиды">
        ...
        <Row kind="client_lead_targeted_reject_reason">Причины отклонения целевых лидов</Row>
