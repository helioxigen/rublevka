...
import { linkedListLoadStart, linkedListLoadFail, linkedListLoadSuccess } from 'core/fetcher/reducers';
...
export default handleActions({
  ...
  [linkedContactTypes.LOAD_LINKED_LIST]: (state, { resource, resourceId, listName, resetState }) => {
  ...
  [linkedContactTypes.LOAD_LINKED_LIST_SUCCESS]: (state, { resource, resourceId, listName, items }) => {
    if (resource === resourceName) {
  ...
  [linkedContactTypes.LOAD_LINKED_LIST_FAIL]: (state, { resource, resourceId, listName, errors }) => {
    if (resource === resourceName) {
