import { uploadElementPhoto, uploadElementPhotoStarted, uploadElementPhotoFailed, uploadElementPhotoSucceeded } from 'core/fetcher/actions';
...
const uploadSelectionPhoto = (id, data) => (dispatch) => {
  ...
  return uploadElementPhoto(resourceName, id, data)
    .then(({ photoId }) => {
