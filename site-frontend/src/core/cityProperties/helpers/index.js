...
export const mapParams = ({ pagination = {}, orderBy = {}, filter = {}, filterNot = {} }) => {
  ...
  return {
    ...
    filter: {
      ...
      'saleOffer.price': makeFilterRange(salePrice.min, salePrice.max, saleMultiplier),
      'rentOffer.price': makeFilterRange(rentPrice.min, rentPrice.max, rentMultiplier),
      ...
      'location.subLocalityId': subLocalities.map(sublocality => sublocality.id),
