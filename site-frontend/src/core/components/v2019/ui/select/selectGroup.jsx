...
import s from 'site/styles/ui/v2019/selectGroup';
import sSelect from 'site/styles/ui/v2019/select';
    ...
    return (
      <div className={s.selectContainer}>
        <Visibility lg="hidden">
          ...
          >
            <option value="placeholder" disabled>от</option>
          ...
          >
            <option value="placeholder" disabled>до</option>
        ...
        <Visibility xs="hidden" sm="hidden" md="hidden" className={s.visibility}>
