...
import { placesToPlaceId } from 'core/countryProperties/constants/dictionaries';
import { dealTypes } from 'core/countryProperties/constants/dictionaries';
...
export const getApiPathByGroup = (group, options) => {
  if (group === 'similar') {
    return `/v1/properties/country/${options.id}/similar/${dealTypes[options.dealType]}`;
  }
