...
import { BlockWrapper, ImgBg, LinksNoTitle, TitleBg, StLink, TextWrapper } from './styled';
...
export default () =>
  (<BlockWrapper>
    ...
    <LinksNoTitle>
      <StLink to="/zagorodnaya/shosse/rublevo-uspenskoe_1178/prodaja/">Рублево-Успенское</StLink>
      <StLink to="/zagorodnaya/shosse/novorijskoe_1186/prodaja/">Новорижское</StLink>
