    ...
    <Container>
      <Row sm="center">
        <Col xs="8">
          ...
          <Paragraph>
            На ваш выбор 400 коттеджных посёлков Подмосковья, включая такие поселки, как Миллениум
            Парк, Никольская слобода, Сады Майендорф, Царское село и другие.
          </Paragraph>

          <Paragraph>
            За 10 лет мы помогли купить элитную загородную недвижимость более чем тысяче семей.
            Поможем и вам: проконсультируем, подберём варианты, организуем просмотр понравившихся
            объектов и, конечно, обеспечим безукоризненное сопровождение вашей сделки.
          </Paragraph>

          <Paragraph>
            С нами вы сможете купить дом по самой привлекательной цене и на лучших условиях!{' '}
          </Paragraph>
