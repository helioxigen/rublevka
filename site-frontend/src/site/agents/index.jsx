          ...
          <Container>
            <Row xs="center">
              <Col xs="12" className={s.agentContainer}>
                ...
                <div className={cn(sUtils.pushedTopXs3_5Sm4_5Md2_8, s.padding0_3)}>
                  <p className={cn(s.textGreyXs, s.lineHeight3_9)}>
                    Агенты помогают покупателю найти и купить дом мечты, а собственнику — продать быстро и по объективной цене. <br className={sUtils.hideXsSmMd} />В JQ Estate работают агенты городской и загородной недвижимости. Они разбираются в рынке, ориентируются в законах и умеют вести переговоры.
                  </p>
                </div>
              </Col>
            </Row>
