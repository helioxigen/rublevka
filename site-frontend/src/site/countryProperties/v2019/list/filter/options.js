...
export const prices = {
  ...
  rub: {
    sale: [
      { value: 0, label: '0 ₽' },
      { value: 10, label: '50 млн ₽' },
      { value: 20, label: '100 млн ₽' },
      { value: 30, label: '150 млн ₽' },
      { value: 40, label: '200 млн ₽' },
      { value: 50, label: '250 млн ₽' },
      { value: 60, label: '300 млн ₽' },
      { value: 70, label: '350 млн ₽' },
      { value: 80, label: '400 млн ₽' },
      { value: 90, label: '450 млн ₽' },
      { value: 100, label: '500 млн ₽' },
      { value: 110, label: '550 млн ₽' },
      { value: 120, label: '600+ млн ₽' },
    ],
    rent: [
      { value: 0, label: '0' },
      { value: 10, label: '10 тыс/мес.' },
