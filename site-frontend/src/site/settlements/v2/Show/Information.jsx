...
const { Loading, ParamList, Button, Grid: { Container, Row, Col } } = UI;
              ...
              <Col xs="12" className={s.divider}>
                {hasAnyDetails && (
                  <Button
                    className={cn(
                      st.settlement.tab,
                      this.state.currentTab === 'common' && st.settlement.tabActive,
                    )}
                ...
                {hasInfrastructure && (
                  <Button
                    className={cn(
                      st.settlement.tab,
                      this.state.currentTab === 'infrastructure' && st.settlement.tabActive,
                    )}
                          ...
                          <Col sm="6" md="4">
                            <div>
                              ...
                              {!!landState.length && (
                                ...
                                >
                                  {landState.map(item => (
                                    <span>&nbsp;{dictionary.landState[item]}</span>
                                  ))}
                                </ParamList>
                              )}
                            </div>
